...
std::vector<std::map<std::string, std::string>> Ultimate2Joypad::get_udev_events() const {
  std::vector<std::map<std::string, std::string>> events;
...
std::vector<std::pair<std::string, std::vector<std::string>>> Ultimate2Joypad::get_udev_hw_db_entries() const {
  std::vector<std::pair<std::string, std::vector<std::string>>> result;
