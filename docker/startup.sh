...
# Copy fake-uinput broker + LD_PRELOAD interceptor library
cp /wolf/fake-uinput-broker $HOST_APPS_STATE_FOLDER/fake-uinput-broker
cp /wolf/libfake-uinput.so $HOST_APPS_STATE_FOLDER/libfake-uinput.so
cp /wolf/libfake-uinput32.so $HOST_APPS_STATE_FOLDER/libfake-uinput32.so
